...
const LoginForm = () => {
    let {isLoggedIn ,onLoggedChange, SERVER_IP}= useContext(LogingedContext);
    console.log("logingedCon = " , isLoggedIn)
    console.log("onLoggedChange = " , onLoggedChange)
